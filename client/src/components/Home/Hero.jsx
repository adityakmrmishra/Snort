...
import { MainImg ,faceModelPath} from "../../assets/export"; // Adjust if needed
...
const Hero = ({ setCapturedImage }) => {
    ...
    // const [faceModel, setFaceModel] = useState(null); // State for 3D model
    ...
    const handleVideoPlay = () => {
        ...
        setInterval(async () => {
            ...
            // Draw the overlay image on top of the video frame
    ...
    image.src = faceModelPath; // Replace with the path to your image
    image.onload = () => {
    ...
    const captureImage = (resizedDetections) => {
        if (videoRef.current && canvasRef.current) {
            ...
            overlayImage.src = faceModelPath                        ;
            overlayImage.onload = () => {
            ...
            <div className="text-white flex flex-col items-center w-full">
                ...
                {/* {stream && (
                    <div className="flex flex-row gap-2 mb-4">
                        ...
                        <button 
                            className="bg-gray-500 text-white px-2 py-1 rounded hover:bg-gray-700 transition"
                            onClick={() => applyFilter('brightness(150%)')}
                        >
                            Brightness
                        </button>
                        <button 
